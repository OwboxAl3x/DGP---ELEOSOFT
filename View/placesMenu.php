...
<div class="home">
    ...
    <div class="home_content">
        <div class="home_title">Lugares</div>
    </div>
</div>
...
<div class="intro">
    <div class="container">
        <div class="row">
            <div class="col">
                <h2 class="intro_title text-center">¡No hay lugar, como nuestro lugar!</h2>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-10 offset-lg-1">
                <div class="intro_text text-center">
                    <p>Los rincones más hermosos de Granada están con nosotros. </p>
                </div>
            </div>
        </div>
